...
void enemy_movement() {
	CP_Image_Draw(bug.enemyDesign, bug.enemyPosition.x, bug.enemyPosition.y, 100, 100, 255);
...
void enemy_damage() {
	...
	if (CP_Input_MouseTriggered(MOUSE_BUTTON_1))
	{
		...
		{
			CP_Image_Draw(bug.enemyDead, bug.enemyPosition.x, bug.enemyPosition.y, 100, 100, 255);
